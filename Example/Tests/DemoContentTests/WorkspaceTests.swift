...
struct WorkspaceTests {
  ...
  @Test func messageActionsAreKeyboardReachable() {
    let h = Harness()
    h.move(.down, .down, .right, .stepIn, .stepIn, .stepIn, .down, .left, .stepIn)
