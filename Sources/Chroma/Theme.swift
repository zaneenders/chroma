...
public struct FocusStyle: Equatable, Sendable {
  ...
  public var pressedHighlight: Color
  ...
  public init(
    ...
    self.pressedHighlight = pressedHighlight
...
public struct ChromaTheme: Equatable, Sendable {
  ...
  public static let dark = ChromaTheme(
    ...
    accent: Color(r: 0.467, g: 0.867, b: 0.467, a: 1),
    ...
    textField: TextFieldStyle(
      ...
      caret: .white,
      border: Color(r: 0.16, g: 0.19, b: 0.25, a: 1),
      editingBorder: Color(r: 0.467, g: 0.867, b: 0.467, a: 1)),
    scrollView: ScrollViewStyle(indicator: Color(r: 1, g: 1, b: 1, a: 0.45)),
    focus: FocusStyle(
      ring: Color(r: 0.467, g: 0.867, b: 0.467, a: 1),
